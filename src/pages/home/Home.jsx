    ...
    <motion.section className="home-about">
      <div className="container about__content">
        <div className="about__text">
          ...
          <p className="about__description">
            Browse and filter invoices in seconds, search by client name,
            invoice number or date range, and customize exactly which fields you
            want to see for a streamlined workflow.
          </p>
        </div>
        <motion.div className="about__image">
          {/* Illustration placeholder */}
    ...
    <motion.section className="home-about">
      <div className="container about__content">
        <div className="about__text">
          ...
          <p className="about__description">
            Invoxly lets you quickly scan, upload, and organize your documents
            in just a few clicks, no extra hardware needed.
          </p>
        </div>
        <motion.div className="about__image">
          {/* Illustration placeholder */}
